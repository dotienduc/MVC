            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown dropdown-user admin-user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="../DashboardController/logout"><i class="fa fa-sign-out"></i> Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\mvc\app\views\admin/partial/mainHeader.blade.php ENDPATH**/ ?>