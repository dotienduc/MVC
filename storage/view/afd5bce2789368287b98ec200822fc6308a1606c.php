...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="info">
                <h4>Welcome</h4>
                <p><?php echo e($infoAccount[0]->name); ?></p>
            </div>
        </div>

        <?php if( isset($_SESSION['info']) && $_SESSION['info'][0]->role == 1 ): ?>
        <!-- sidebar menu -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="../QuestionController/listQuestion">
                    <i class="fa fa-list-alt"></i> <span>Danh sách câu hỏi</span>
                </a>
            </li>  
        </ul>
        <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\mvc\app\views\admin/partial/mainSlidebar.blade.php ENDPATH**/ ?>