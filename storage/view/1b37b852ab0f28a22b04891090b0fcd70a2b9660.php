...
<style>
        #loading{
                text-align: center;
                background: url('../../../public/tenor.gif') no-repeat center;
                height: 100%;
                width: 100%;
        }
</style>
                                   ...
                                   <div class="panel-body">
                                    <form class="col-sm-12">
                                           <div class="col-sm-6 form-group">
                                                  <label>Tên</label>
                                                  <input type="text" class="form-control" required value="<?php echo e($question['name']); ?>">
                                          </div>
                                          <div class="col-sm-6 form-group">
                                                  <label>Email</label>
                                                  <input type="text" class="form-control" required value="<?php echo e($question['email']); ?>">
                                          </div>
                                          <div class="col-sm-12 form-group">
                                                  <label>Chủ đề</label>
                                                  <input type="email" class="form-control"  required value="<?php echo e($question['subject']); ?>">
                                          </div> 
                                          <div class="col-sm-12 form-group">
                                                  <label>Nội dung câu hỏi</label>
                                                  <textarea id="some-textarea" class="form-control" rows="10" ><?php echo e($question['message']); ?></textarea>
                                          </div> 
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                    ...
                    <div class="modal-body">
                     <form action="" method="POST" id="form-submit" role="form">
                            ...
                            <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" name="nameDoctor" value="<?php echo e($infoAccount['name']); ?>">
                           </div>
                           <div class="form-group">
                                   <label for="">Chủ đề</label>
                                   <input type="text" class="form-control" name="subject" value="<?php echo e($question['subject']); ?>">
                           </div>
                   ...
                   <div class="modal-footer">
                          <input type="hidden" name="id_questionHidden" value="<?php echo e($question['id']); ?>">
                          <input type="hidden" name="id_emailHidden" value="<?php echo e($question['email']); ?>">
...
<script type="text/javascript">
        $(document).ready(function(){
                ...
                $('#form-submit').on('submit', function(e){
                     e.preventDefault();
                     $('.hold-transition').html('<div id="loading"></div>');
...
<?php /**PATH C:\xampp\htdocs\mvc\app\views\admin/formquestion.blade.php ENDPATH**/ ?>