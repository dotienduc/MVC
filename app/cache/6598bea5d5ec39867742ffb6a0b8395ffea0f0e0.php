							...
							<div class="panel panel-info panel-border">
								...
								<form action="" method="POST" id="form-checkout">
									<div class="panel-body">
										...
										<div class="form-group">
											<div class="col-md-12">
												<input type="hidden" name="hidden_total" id="hidden_total" value="<?php echo e($total + $shipping); ?>">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="col-sm-3 col-xs-3">
								<img class="img-responsive" src="../img/shop/<?php echo e($item['product_image']); ?>" />
							</div>
							<div class="col-sm-6 col-xs-6">
								<div class="col-xs-12"><?php echo e($item['product_name']); ?></div>
								<div class="col-xs-12"><small>Số lượng :<span><?php echo e($item['product_quantity']); ?></span></small></div>
							</div>
							<div class="col-sm-3 col-xs-3 text-right">
								<h5><span>$</span><?php echo e($item['product_quantity'] * $item['product_price']); ?></h5>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-12">
								...
								<div class="pull-right"><span>$</span><span><?php echo e($total); ?></span></div>
							</div>
							<div class="col-xs-12">
								<small>Phí giao hàng</small>
								<div class="pull-right"><span>+ $<?php echo e($shipping); ?></span></div>
							</div>
						</div>
						<div class="form-group"><hr /></div>
						<div class="form-group">
							<div class="col-xs-12">
								...
								<div class="pull-right"><span>$</span><span><?php echo e($total + $shipping); ?></span></div>
							</div>
						</div>
					</div>
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mvc\app\views\home/checkout.blade.php ENDPATH**/ ?>